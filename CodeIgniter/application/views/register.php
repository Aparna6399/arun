          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="../../pages/samples/Registration.html"> Registration </a></li>
...
<?php } ?>
              ...
              <form action="admin" method="post">
                ...
                <div class="form-group">
                  <input type="email" name="emailid" class="form-control form-control-lg" id="emailid" placeholder="Enter Your Email">
                </div>
                <div class="form-group">
                  <input type="text" name="mobnumber" class="form-control form-control-lg" id="contactno" placeholder="Enter Your Contact Number">
                </div>
                <div class="form-group">
                  <input type="text" name="address" class="form-control form-control-lg" id="address" placeholder="Enter Your Address">
                </div>
                
                <div class="mt-3">
                  <input type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" name="submit" value="Signup">
                </div>
